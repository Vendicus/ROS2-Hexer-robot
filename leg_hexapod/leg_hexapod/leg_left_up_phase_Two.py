...
from .submod.left_tourning_up_leg import tourning as tourn
...
class up_left(Node):
    def __init__(self, angle_start_x, angle_start_y, angle_start_z, tourning_var, speed, Z):
        super().__init__('left_up_publisher')
        self.publisher_LU_walk = self.create_publisher(ThetasAll, 'anglesULLegList', 10)
    ...
    def ultra(self, msg):
        ...
        self.publisher_LU_walk.publish(msg)
